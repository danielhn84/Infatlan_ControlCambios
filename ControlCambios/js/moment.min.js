...
! function (a, b) {
    ...
    // LOCALES
    var ke = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        le = "Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Deciembre".split("_"),
        me = "Ene_Feb_Mar_Abr_May_Jun_Jul_Ago_Sep_Oct_Nov_Dic".split("_"),
        ne = Zd,
        oe = Zd;
    // FORMATTING
    U("Y", 0, 0, function () {
    ...
    // LOCALES
    var re = "Domingo_Lunes_Martes_Miercoles_Jueves_Viernes_Sabado".split("_"),
        se = "Dom_Lun_Mar_Mie_Jue_vie_Sab".split("_"),
