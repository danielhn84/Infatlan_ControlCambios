    ...
    <div id="smartwizard">
        <ul>
            <li><a href="#step-1">Paso 1<br />
                <small>Datos del Cambio</small></a></li>
            <li><a href="#step-2">Paso 2<br />
                <small>Datos Técnicos</small></a></li>
            <li><a href="#step-3">Paso 3<br />
                <small>Procesamiento</small></a></li>
            <li><a href="#step-4">Paso 4<br />
                <small>Subir archivos</small></a></li>
            <li id="LIPaso5" runat="server" visible="false"><a href="#step-5">Paso 5<br />
                <small>Revisión de QA</small></a></li>
            <li id="LIPaso6" runat="server" visible="false"><a href="#step-6">Paso 6<br />
                <small>Cierre de Cambio</small></a></li>
        </ul>
        <div>
            <div id="step-1" class="" style="height: initial !important;">
                <h3 class="border-bottom border-gray pb-2" style="padding-top: 10px;">Datos del Cambio</h3>
            ...
            <div id="step-2" class="" style="height: initial;">
                <h3 class="border-bottom border-gray pb-2" style="padding-top: 10px;">Datos Técnicos</h3>
            ...
            <div id="step-3" class="" style="height: initial;">
                <h3 class="border-bottom border-gray pb-2" style="padding-top: 10px;">Procesamiento (Paso a paso)</h3>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <div class="row">
                            <div class="col-12 grid-margin stretch-card">
                                <asp:Button ID="BtnAgregarProcedimiento" runat="server" class="btn btn-twitter mr-2 " data-toggle="modal" data-target="#ProcedimientosModal" Text="(+) Procedimiento" />
                            </div>
                        </div>
            ...
            <div id="step-4" class="" style="height: initial;">
                <h3 class="border-bottom border-gray pb-2" style="padding-top: 10px;">Subir archivos</h3>
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
            ...
            <div id="step-5" class="" style="height: initial;">
                <h3 class="border-bottom border-gray pb-2" style="padding-top: 10px;">Revisión de QA</h3>
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-description">
                                    Tener en cuenta que este es el ultimo para para la ejecución o cancelación del cambio.             
                                </p>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <asp:DropDownList ID="DDLRevisionQA" runat="server" class="form-control">
                                                    ...
                                                    <asp:ListItem Value="2">Activar el cambio para cierre y ejecución</asp:ListItem>
                                                    <asp:ListItem Value="3">Cambio cerrado</asp:ListItem>
                                                </asp:DropDownList>
                                ...
                                <div class="row">
                                    <div class="d-flex justify-content-between align-items-end flex-wrap">
                                        <asp:UpdatePanel ID="UpdateRevisionQA" runat="server">
                                            <ContentTemplate>
                                                <asp:Button ID="BtnRevisionQA" class="btn btn-success mr-2" runat="server" Text="Aplicar revisión QA" OnClick="BtnRevisionQA_Click" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                </div>
                ...
                <div class="modal-body">
                    <asp:UpdatePanel ID="UpdateComunicaciones" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Cambio</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Incidente</label>
                                <div class="col-sm-9">
    ...
    <div class="modal fade" id="ConfirmacionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label class="label">¿Estas seguro de crear el cambio?</label>
                </div>
                <div class="modal-footer">
